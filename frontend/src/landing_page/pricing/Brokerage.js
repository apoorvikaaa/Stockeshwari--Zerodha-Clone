        ...
        <div className='container p-5 text-muted'>
            <div className='row'>
                <div className='col p-4'>
                    ...
                    <h5 className='mt-5'>Securities/Commodities transaction tax</h5>
                    <p className='mt-3 f'>Tax by the government when transacting on the exchanges. Charged as above on both buy and sell sides when trading equity delivery. Charged only on selling side when trading intraday or on F&O.</p>
                    <p>When trading at Zerodha, STT/CTT can be a lot more than the brokerage we charge. Important to keep a tab.</p>

                    <h5 className='mt-5'>Transaction/Turnover Charges</h5>
                    <p className='mt-3'>Charged by exchanges (NSE, BSE, MCX) on the value of your transactions.</p>
                    ...
                    <h5 className='mt-5'>Call & trade</h5>
                    <p className='mt-3'>Additional charges of ₹50 per order for orders placed through a dealer at Zerodha including auto square off orders.</p>
                    
                    <h5 className='mt-5'>Stamp charges</h5>
                    ...
                    <h5 className='mt-5'>NRI brokerage charges</h5>
                    <ul>
                    ...
                    <h5 className='mt-5'>Account with debit balance</h5>
                ...
                <div className='col p-4' style={{marginTop:"33px"}}>
                    <h5 className='mt-5'>GST</h5>
                    <p className='mt-3'>Tax levied by the government on the services rendered. 18% of ( brokerage + SEBI charges + transaction charges)</p>

                    <h5 className='mt-5'>SEBI Charges</h5>
                    <p className='mt-3'>Charged at ₹10 per crore + GST by Securities and Exchange Board of India for regulating the markets.</p>

                    <h5 className='mt-5'>DP (Depository participant) charges</h5>
                    <p className='mt-3'>₹15.34 per scrip (₹3.5 CDSL fee + ₹9.5 Zerodha fee + ₹2.34 GST) is charged on the trading account ledger when stocks are sold, irrespective of quantity.</p>
